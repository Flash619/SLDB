...
class Operator{
	...
	* @throws InvalidOperatorArgumentsException If the supplied condition is not valid.
	*/
	...
	* @return Operator This operator.
	* @throws InvalidOperatorArgumentsException If the supplied conditions are not valid.
	*/
	...
	* @return Operator This operator.
    * @throws InvalidOperatorArgumentsException If the supplied conditions within this operator are not valid.
	*/
    ...
    * @return bool Validation result. True if valid.
	* @throws InvalidOperatorArgumentsException If the supplied conditions are not valid.
	*/
